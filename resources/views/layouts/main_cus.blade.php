  ...
  <div class=" container-scroller">
    ...
    <nav class="navbar navbar-default col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
      <div class="bg-white text-center navbar-brand-wrapper">
        <a class="navbar-brand brand-logo" href="dashcustomer"><img src={{asset('../dashboard/images/logo_nav.png')}} /></a>
        <a class="navbar-brand brand-logo-mini" href="dashcustomer"><img src={{asset('../dashboard/images/logo_nav_mini.png')}} alt=""></a>
      </div>
            ...
            {{-- <li class="nav-item"> --}}
                ...
                <li class="nav-item action" >
                  <i class="fa fa-1x fa-key text-primary2 mb-3 sr-icons"></i>
                    <a class="nav-item" style="color:#f05f40;" href="{{ route('customer.logout') }}">
                        {{-- onclick="event.preventDefault();
                                 document.getElementById('logout-form').submit();"> --}}
                        Logout
                    </a>

                    {{-- <form id="logout-form" action="{{ route('caregiver.logout') }}" method="POST" style="display: none;">
                        {{ csrf_field() }}
                    </form> --}}
                </li>
            {{-- </li> --}}
      ...
      <div class="row row-offcanvas row-offcanvas-right">
        ...
        <nav class="bg-white sidebar sidebar-offcanvas" id="sidebar">
          <div class="user-info">
            ...
            <p class="name">สวัสดีคุณลูกค้า</p>
          ...
          <ul class="nav">
            <li class="nav-item active">
              <a class="nav-link" href="dashcustomer">
            ...
            <li class="nav-item active">
              <a class="nav-link" href="cusselect">
