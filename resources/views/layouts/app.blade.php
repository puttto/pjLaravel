...
<body id="page-top">
    ...
    <div class="container">
      <a class="navbar-brand js-scroll-trigger" href="#page-top">สุขใจ อินเตอร์กรุ๊ป</a> &nbsp;&nbsp;
      <a clsss=" navbar-brand js-scroll-trigger" style="font-size: 16px;" href="tel:+66614844107"> โทร 061-4844107</a>
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        ...
        <ul class="navbar-nav ml-auto">
          ...
          @if (!Auth::guard('customer')->check())
              ...
              <li class="nav-item"><a class="nav-link js-scroll-trigger" href="{{ route('customer.login.submit')}}">Login</a></li>
