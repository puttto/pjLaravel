                    ...
                    {{ Auth::user()->name }}
                      ...
                      <li class="nav-item action" >
                        <i class="fa fa-1x fa-key text-primary2 mb-3 sr-icons"></i>
                          <a class="nav-item" style="color:#f05f40;" href="{{ route('caregiver.logout') }}">
      ...
      <div class="row row-offcanvas row-offcanvas-right">
        ...
        <nav class="bg-white sidebar sidebar-offcanvas" id="sidebar">
          <div class="user-info">
            ...
            <br><br><br>
            <p class="name">สวัสดีคุณผู้ดูแล</p>
            <p class="name">{{  Auth::guard('caregiver')->user()->name }}</p>
            {{-- <p class="designation">Manager</p> --}}
          <br><br><br>  <span class="online"></span>
          </div>
          <ul class="nav">
            <li class="nav-item active">
              <a class="nav-link" href="dashcaregiver">
            ...
            <li class="nav-item active">
              <a class="nav-link" href="addactivity">
