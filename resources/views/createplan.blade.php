                   ...
                   <div class="form-horizontal">
                       ...
                       <div class=" col-sm-12">
                         ...
                         <div class="form-group">
                           ...
                           <input type="radio" name="has_time"  id="has_time_no" value="ไม่มีช่วงเวลา" onclick="show('has_time_div')">
                            <label for="has_time_lb">ไม่ระบุช่วงเวลา</label>
                            <input type="radio" id="has_time_yes" name="has_time" value="มีช่วงเวลา" onclick="show('has_time_div')">
                             <label for="has_time_lb">ระบุช่วงเวลา</label>
