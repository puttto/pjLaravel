...
<div class="content-wrapper">
  <div class="container">
    ...
    {{-- {{Form::open(['method'=>'put','route'=>['search.update',$input->id_caregivers]])}} --}}
    ...
    <div class="col-xl-3 col-lg-3 col-md-3 col-sm-6 mb-4 caregivers" data-id="{{$input ['id_caregivers']}}">
      ...
      <div class="card" >
        ...
        <div class="card-footer">
          {{-- <a href="#" class="btn btn-primary">ดูรายละเอียด</a> --}} {{-- {{Html::link('detail/'.$show['id_patients'],'แสดงรายละเอียด',array('class'=>'btn btn-primary'))}} --}}
        </div>
      </div>
    </div>
...
{{Form::close()}} {{-- {{Form::text('name','',['class' => 'form-control'])}} {{ Form::submit('Save',['class' => 'btn btn-primary'])
}} --}}
