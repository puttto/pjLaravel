      ...
      <div class="card">
        ...
        <div class="form-group">
          ...
          <div class="form-group">
            ...
            <input type="number" min="1" name="vol" class="form-control p-input" value="">
          </div>
          <div class="form-group">
            <label for="water_lb">น้ำตาม (cc)</label>
            <input type="number" min="1" name="water" class="form-control p-input" value="">
          </div>
